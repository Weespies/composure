...
public class Person implements ListDataListener, DocumentListener,Serializable {
	 ...
	 * @param asset
	 * @return true if the asset is present.  Major/Minor is not
	 * checked.
	 */
	 ...
	 * @throws IllegalArgumentException if this character already has this asset.
	 */
	 ...
	 * @param complication Complication to add
	 * @throws IllegalArgumentException if this character already has this asset.
	 */
	 ...
	 * @param complication
	 * @return true if the complication has been removed, false if not (probably because it's not present).
	 */
	 ...
	 * @param asset
	 * @return true if the asset has been removed, false if not (probably because it's not present).
	 */
	...
	/**
	 * @param newAssets The assets to set.
	 */
	...
	/**
	 * @param newComps The complications to set.
	 */
	...
	/**
	 * @param mainStats The mainStats to set.
	 */
...
//	}
	...
	/**
	 * @param startingPoints The startingPoints to set.
	 */
	...
	public int getStatMax() {
		switch (level) {
			default:	return 12;
			case LEVEL_GREENHORN : return STAT_MAX_GREENHORN ;
			case LEVEL_VETERAN : return STAT_MAX_VETERAN ;
			case LEVEL_BIG_DAM_HERO : return STAT_MAX_BIG_DAM_HERO ;
		}
	}
	...
	/**
	 * Return the skill point allocation, i.e. the number of skill points
	 * this character starts with.
	 */
	 ...
	 * This listener is just a direct pass through to the SkillSheet.
	 * @param cl
	 */
	...
	/**
	 * Listener for watching the asset lists and modifiying
	 * the money whenever "Moneyed Inidividual" is added or
	...
	/**
	 * @param personalityTemplate the personalityTemplate to set
	 */
	...
	/**
	 * @param femaleName the name used while this character is female.
	 */
	...
	/**
	 * @param maleName the name used while this character is male.
	 */
	...
	/**
	 * Changes the naem of the person.  If the person is male 
	 * then the male name changes,
	 * if female then the female name changes.
	...
	public boolean canAddNewAsset() {
		return getCurrentStatPoints() >1
			&& getAssets().size()<TRAIT_LIST_MAX_SIZE ;
	}
	...
	public int getEquipmentCount() {
		return equipment.size() + explosives.size() + meleeWeapons.size() 
			+ armor.size() + rangedWeapons.size();
	}
