 ...
 *
 */
public class AvailabilityFieldHandler implements FieldHandler {
	...
	public Object getValue(Object arg0) throws IllegalStateException {
		...
		return ((Equipment)arg0).getAvailability().getCode();
	}
	...
	public void setValue(Object arg0, Object arg1)
		...
		((Equipment)arg0).setAvailability( Availability.getForCode((String)arg1) );
	}
