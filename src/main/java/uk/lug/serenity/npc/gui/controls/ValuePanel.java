...
public class ValuePanel extends JPanel {
	 ...
	 *            minimum value
	 * @param valueStep
	 *            step size for buttons for changing the value.
	 */
	...
	/**
	 * @return true if the plus action is safe to invoke without violating the
	 *         maximum constraint.
	 */
